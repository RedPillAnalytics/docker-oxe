...
COPY $RUN_FILE $PWD_FILE $CHECK_DB_FILE $CONF_FILE ./


RUN yum -y install unzip.x86_64 oracle-database-preinstall-18c file openssl && \
    curl -o $INSTALL_FILE_1 https://s3.amazonaws.com/software.redpillanalytics.io/oracle/xe/18.4.0.0.0/${INSTALL_FILE_1}
